...
unsigned cpm_bdos_10(unsigned char *buffer)
{
    ...
    buffer[1] = curlen;
    for (n = 19; n > 0; n--)
        memcpy(&prev[n][0], &prev[n - 1][0], 257);
